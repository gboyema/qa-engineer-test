...
public class Snare {
    ...
    @FindBy(how = How.XPATH, using = "//section[@class='track-two']/h3")
    WebElement text;

    @FindAll(@FindBy(how = How.XPATH, using = "//section[@class='track-two']/section/button"))
    List<WebElement> notes;

    @FindAll(@FindBy(how = How.XPATH, using = "//section[@class='track-two']/section/input"))
    List<WebElement> rate_detune;

    public Snare (WebDriver driver) {
        this.driver = driver;
