...
public class Closed_hihat {
    private WebDriver driver;

    @FindBy(how = How.XPATH, using = "//section[@class='track-three']/h3")
    WebElement text;

    @FindAll(@FindBy(how = How.XPATH, using = "//section[@class='track-three']/section/button"))
    List<WebElement> notes;

    @FindAll(@FindBy(how = How.XPATH, using = "//section[@class='track-three']/section/input"))
    List<WebElement> rate_detune;

    public Closed_hihat(WebDriver driver) {
        this.driver = driver;
