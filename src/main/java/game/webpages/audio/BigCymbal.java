...
public class BigCymbal {
    private WebDriver driver;

    @FindBy(how = How.XPATH, using = "//section[@class='track-four']/h3")
    WebElement text;

    @FindAll(@FindBy(how = How.XPATH, using = "//section[@class='track-four']/section/button"))
    List<WebElement> notes;

    @FindAll(@FindBy(how = How.XPATH, using = "//section[@class='track-four']/section/input"))
    List<WebElement> rate_detune;

    public BigCymbal(WebDriver driver) {
        this.driver = driver;
